"""
Shared utilities for AI-callable API wrapper scripts.

Provides:
- JSON input parsing (from argv[1] or stdin)
- Standardized result formatting
- Common validation helpers
- Dry-run support
- Timeout-safe HTTP requests

All wrappers in sibling subdirectories import from this module.
"""
