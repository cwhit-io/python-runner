#!/usr/bin/env python3
"""
Planning Center Registrations API wrapper for AI agents.

Supports listing events, attendees, categories, selections, and
signup locations via the Planning Center Registrations API.
...
SERVICE_NAME = "planning_center_registrations"
