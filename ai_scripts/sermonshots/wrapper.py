#!/usr/bin/env python3
"""
SermonShots API wrapper for AI agents.
...
# SermonShots API base - supporting both documented endpoints
SERMONSHOTS_API_BASE = os.environ.get(
    "SERMONSHOTS_API_BASE", "https://api.sermonshots.com"
)
SERVICE_NAME = "sermonshots"


def get_api_key():
    key = os.environ.get("SERMONSHOTS_API_KEY")
    if not key:
        return None
    return key
